...
?>
	...
	<div class="main-container">
		<section class="title-page" style="margin-top: -2rem;	">
			<p>
				<?php
include "../assets/php/update-news-title/update-news-title3.php"
?>
				<a href="../index.php">Trang chủ</a> /
				<a href="../assets/php/category-news.php">Tin tức</a> / &nbsp
				<a href="../assets/php/news3.php">
					<?php
include "../assets/php/news-title/news-title3.php"
?>
				</a>&nbsp
				<a href="../admin/category-news3.php">/ admin</a>
			</p>
		</section>
...
?>">
					...
					<div class="input-wrap" id="admin-news-time">
						...
						<?php
include "../assets/php/update-news-time/update-news-time3.php"
?>
...
?>">
					...
					<div class="input-wrap" id="admin-news-author">
						...
						<?php
include "../assets/php/update-news-author/update-news-author3.php"
?>
...
include "../assets/php/news-author/news-author3.php"
?>">
					</div>
					...
					<div class="input-wrap" id="admin-news-content"
						...
						<?php
include "../assets/php/update-news-content/update-news-content3.php"
?>
...
?>
					...
					<div class="input-wrap" id="admin-news-img">
						...
						<div class="row">
							<div class="col l-7">
								<?php
include "../assets/php/update-news-image/update-news3-image.php"
?>
...
?>
			...
			<a href="category-news4.php" class="">
				<div class="right">
					<?php
