...
?>
	...
	<div class="main-container">
		<section class="title-page" style="margin-top: -2rem;	">
			<p>
				<?php
include "../assets/php/update-news-title/update-news-title2.php"
?>
				<a href="../index.php">Trang chủ</a> /
				<a href="../assets/php/category-news.php">Tin tức</a> / &nbsp
				<a href="../assets/php/news2.php">
					<?php
include "../assets/php/news-title/news-title2.php"
?>
				</a>&nbsp
				<a href="../admin/category-news2.php">/ admin</a>
			</p>
		</section>
...
?>">
					...
					<div class="input-wrap" id="admin-news-time">
						...
						<?php
include "../assets/php/update-news-time/update-news-time2.php"
?>
...
?>">
					...
					<div class="input-wrap" id="admin-news-author">
						...
						<?php
include "../assets/php/update-news-author/update-news-author2.php"
?>
...
include "../assets/php/news-author/news-author2.php"
?>">
					</div>
					...
					<div class="input-wrap" id="admin-news-content"
						...
						<?php
include "../assets/php/update-news-content/update-news-content2.php"
?>
...
?>
					...
					<div class="input-wrap" id="admin-news-img">
						...
						<div class="row">
							<div class="col l-7">
								<?php
include "../assets/php/update-news-image/update-news2-image.php"
?>
...
?>" alt="" id="img1">
		...
		<div class="change-page" style="width: 1140px; margin: 0 auto;">
			<a href="category-news1.php" class="">
				<div class="left">
...
?>
			...
			<a href="category-news3.php" class="">
				<div class="right">
					<?php
