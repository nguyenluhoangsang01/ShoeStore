...
?>
	<div class="main-container">
		<section class="title-page" style="margin-top: -2rem;	">
			<p>
				<?php
include "../assets/php/update-news-title/update-news-title4.php"
?>
				<a href="../index.php">Trang chủ</a> /
				<a href="../assets/php/category-news.php">Tin tức</a> / &nbsp
				<a href="../assets/php/news4.php">
					<?php
include "../assets/php/news-title/news-title4.php"
?>
				</a>&nbsp
				<a href="../admin/category-news4.php">/ admin</a>
			</p>
		</section>
...
?>">
					...
					<div class="input-wrap" id="admin-news-time">
						...
						<?php
include "../assets/php/update-news-time/update-news-time4.php"
?>
...
?>">
					...
					<div class="input-wrap" id="admin-news-author">
						...
						<?php
include "../assets/php/update-news-author/update-news-author4.php"
?>
...
include "../assets/php/news-author/news-author4.php"
?>">
					</div>
					...
					<div class="input-wrap" id="admin-news-content"
						...
						<?php
include "../assets/php/update-news-content/update-news-content4.php"
?>
...
?>
					...
					<div class="input-wrap" id="admin-news-img">
						...
						<div class="row">
							<div class="col l-7">
								<?php
include "../assets/php/update-news-image/update-news4-image.php"
?>
