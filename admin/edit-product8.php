...
<body>
	...
	<?php
include "../assets/php/component/product1-admin-header.php"
?>
	<div class="main-container">
		<section class="title-page" style="margin-top: -2rem;	">
			<p>
				<a href="../index.php">Trang chủ</a> /
				<a href="../assets/php/men's-shoes.php"><?php
include "../assets/php/category-product/category-product1.php"
?></a> / &nbsp
				<?php
include "../assets/php/update-product-title/update-product-title8.php"
?>
				<a href="../assets/php/product8.php">
					<?php
include "../assets/php/product-title/product-title8.php"
?>
				</a>&nbsp
				<a href="../admin/edit-product8.php">/ admin</a>
			</p>
		</section>
...
?>">
					...
					<div class="admin-group sale-cost">
						...
						<?php
include "../assets/php/update-product-sale/update-product-sale8.php"
?>
						<input type="text" id="sale-product" name="sale-product"
							placeholder="Nhập giá khuyến mãi..." value="<?php
include "../assets/php/product-sale/product-sale8.php"
?>">


						<label for="cost-product" id="cost-label">Giá gốc: </label>
						<?php
include "../assets/php/update-product-cost/update-product-cost8.php"
?>
						<input type="text" id="cost-product" name="cost-product"
							placeholder="Nhập giá gốc..." value="<?php
include "../assets/php/product-cost/product-cost8.php"
?>">
					</div>
					...
					<div class="admin-group" id="admin-group-introduce">
						...
						<?php
include "../assets/php/update-introduce-product/update-introduce-product8.php"
?>
						<textarea id="introduce-product" name="introduce-product"
							placeholder="Nhập nội dung giới thiệu..."
							class="introduce-product">
						<?php
include "../assets/php/introduce-product/introduce-product8.php"
?>
						</textarea>
						<script>
						ClassicEditor
					...
					<div class="admin-group" id="admin-group-code">
						...
						<?php
include "../assets/php/update-code-product/update-code-product8.php"
?>
						<input type="text" id="code-product" name="code-product"
							class="code-product" placeholder="Nhập mã sản phẩm..." value="<?php
include "../assets/php/code-product/code-product8.php"
?>">
					...
					<div class="admin-group" id="admin-group-tag">
						...
						<?php
include "../assets/php/update-tag-product/update-tag-product8.php"
?>
						<input type="text" id="tag-product" name="tag-product"
							class="tag-product" placeholder="Nhập thẻ sản phẩm..." value="<?php
include "../assets/php/tag-product/tag-product8.php"
?>">
					...
					<div class="admin-group" id="admin-group-category">
						...
						<?php
include "../assets/php/update-category-product/update-category-product1.php"
?>
						<input type="text" id="category-product" class="category-product"
							name="category-product" placeholder="Nhập danh mục sẩn phẩm"
							value="<?php include "../assets/php/category-product/category-product1.php"?>">
		...
		<div class="grid wide">
			<div class="row">
				<form method="POST" class="admin"
					style="margin-top: 7rem; margin-bottom: 10rem;"
					...
					<div class="admin-description-group"
						...
						<?php
include "../assets/php/update-introduce-trademaker-product/update-introduce-trademaker-product8.php"
?>
...
<?php
include "../assets/php/introduce-trademaker-product/introduce-trademaker-product8.php"
?>
						</textarea>
						<script>
						ClassicEditor
					...
					<div class="admin-description-group" id="admin-group-img">
						...
						<div class="row">
							<?php
include "../assets/php/update-image-product/update-image-product8.php"
?>
							<div class="col l-7">
...
?>" alt="" id="img1">
					...
					<div class="admin-description-group"
						...
						<?php
include "../assets/php/update-commitment-product/update-commitment-product8.php"
?>
...
<?php
include "../assets/php/commitment-product/commitment-product8.php"
?>
						</textarea>
						<script>
						ClassicEditor
					...
					<div class="admin-description-group"
						...
						<?php
include "../assets/php/update-howtobuy-product/update-howtobuy-product8.php"
?>
...
<?php
include "../assets/php/howtobuy-product/howtobuy-product8.php"
?>
						</textarea>
						<script>
						ClassicEditor
					...
					<div class="admin-description-group"
						...
						<?php
include "../assets/php/update-contact-info/update-contact-info8.php"
?>
...
<?php
include "../assets/php/contact-info/contact-info8.php"
?>
						</textarea>
						<script>
						ClassicEditor
					...
					<div class="admin-description-group" id="admin-size-group-introduce">
						...
						<?php
include "../assets/php/update-size-product/update-size-product8.php"
?>
...
include "../assets/php/size-product/size-product8.php"
?>">
					...
					<div class="admin-description-group" id="admin-color-group-introduce">
						...
						<?php
include "../assets/php/update-color-product/update-color-product8.php"
?>
...
include "../assets/php/color-product/color-product8.php"
?>">
					...
					<div class="admin-description-group"
						...
						<?php
include "../assets/php/update-weight-product/update-weight-product8.php"
?>
...
include "../assets/php/weight-product/weight-product8.php"
?>">
