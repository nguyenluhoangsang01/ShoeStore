...
?></a> / &nbsp
				<?php
include "../assets/php/update-product-title/update-product-title17.php"
?>
				<a href="../assets/php/product17.php">
					<?php
include "../assets/php/product-title/product-title17.php"
?>
				</a>&nbsp
				<a href="../admin/edit-product17.php">/ admin</a>
			</p>
		</section>
...
?>">
					...
					<div class="admin-group sale-cost">
						...
						<?php
include "../assets/php/update-product-sale/update-product-sale17.php"
?>
						<input type="text" id="sale-product" name="sale-product"
							placeholder="Nhập giá khuyến mãi..." value="<?php
include "../assets/php/product-sale/product-sale17.php"
?>">


						<label for="cost-product" id="cost-label">Giá gốc: </label>
						<?php
include "../assets/php/update-product-cost/update-product-cost17.php"
?>
						<input type="text" id="cost-product" name="cost-product"
							placeholder="Nhập giá gốc..." value="<?php
include "../assets/php/product-cost/product-cost17.php"
?>">
					</div>
					...
					<div class="admin-group" id="admin-group-introduce">
						...
						<?php
include "../assets/php/update-introduce-product/update-introduce-product17.php"
?>
						<textarea id="introduce-product" name="introduce-product"
							placeholder="Nhập nội dung giới thiệu..."
							class="introduce-product">
						<?php
include "../assets/php/introduce-product/introduce-product17.php"
?>
						</textarea>
						<script>
						ClassicEditor
					...
					<div class="admin-group" id="admin-group-code">
						...
						<?php
include "../assets/php/update-code-product/update-code-product17.php"
?>
						<input type="text" id="code-product" name="code-product"
							class="code-product" placeholder="Nhập mã sản phẩm..." value="<?php
include "../assets/php/code-product/code-product17.php"
?>">
					...
					<div class="admin-group" id="admin-group-tag">
						...
						<?php
include "../assets/php/update-tag-product/update-tag-product17.php"
?>
						<input type="text" id="tag-product" name="tag-product"
							class="tag-product" placeholder="Nhập thẻ sản phẩm..." value="<?php
include "../assets/php/tag-product/tag-product17.php"
?>">
			...
			<div class="row">
				<form method="POST" class="admin"
					...
					<div class="admin-description-group"
						...
						<?php
include "../assets/php/update-introduce-trademaker-product/update-introduce-trademaker-product17.php"
?>
...
<?php
include "../assets/php/introduce-trademaker-product/introduce-trademaker-product17.php"
?>
						</textarea>
						<script>
						ClassicEditor
					...
					<div class="admin-description-group" id="admin-group-img">
						...
						<div class="row">
						<?php
include "../assets/php/update-image-product/update-image-product17.php"
?>
							<div class="col l-7">
								<label for="img-description-product1" class="edit-img1">
									<img src="../assets/img/<?php
include "../assets/php/image-product/image-product17.php"
?>" alt="" id="img1">
								</label>
							</div>
							<div class="col l-5">
					...
					<div class="admin-description-group"
						...
						<?php
include "../assets/php/update-commitment-product/update-commitment-product17.php"
?>
...
<?php
include "../assets/php/commitment-product/commitment-product17.php"
?>
						</textarea>
						<script>
						ClassicEditor
					...
					<div class="admin-description-group"
						...
						<?php
include "../assets/php/update-howtobuy-product/update-howtobuy-product17.php"
?>
...
<?php
include "../assets/php/howtobuy-product/howtobuy-product17.php"
?>
						</textarea>
						<script>
						ClassicEditor
					...
					<div class="admin-description-group"
						...
						<?php
include "../assets/php/update-contact-info/update-contact-info17.php"
?>
...
<?php
include "../assets/php/contact-info/contact-info17.php"
?>
						</textarea>
						<script>
						ClassicEditor
					...
					<div class="admin-description-group" id="admin-size-group-introduce">
						...
						<?php
include "../assets/php/update-size-product/update-size-product17.php"
?>
...
include "../assets/php/size-product/size-product17.php"
?>">
					...
					<div class="admin-description-group" id="admin-color-group-introduce">
						...
						<?php
include "../assets/php/update-color-product/update-color-product17.php"
?>
...
include "../assets/php/color-product/color-product17.php"
?>">
					...
					<div class="admin-description-group"
						...
						<?php
include "../assets/php/update-weight-product/update-weight-product17.php"
?>
...
include "../assets/php/weight-product/weight-product17.php"
?>">
