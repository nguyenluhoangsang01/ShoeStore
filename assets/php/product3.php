...
?>
	...
	<div class="cart-shopping">
		<form action="order-pay3.php" method="POST">
			<?php
...
?></a> /
				<a href="product3.php">
					<?php
include "product-title/product-title3.php"
?>
				</a>
			</p>

			<a href="../../admin/edit-product3.php">
			<i class="fas fa-edit"
...
?>" alt="" class="my-slides fade" />
								...
								<div class="col l-7">
									<div class="content-product__name" style="line-height: 1.3; ">
										<?php
include "../php/product-title/product-title3.php"
?>
									</div>
									<div class="content-product__cost">
										<s class="mr2r"><?php include "product-cost/product-cost3.php"?>
										</s>
										<p><?php include "product-sale/product-sale3.php"?>
										</p>
									</div>
									<div class="content-product__list">
										<?php
include "introduce-product/introduce-product3.php"
?>
									</div>
									...
									<a href="order-pay3.php" class="btn buy-product"
										id="buy-product">
										Mua ngay
									</a>
...
include "code-product/code-product3.php"
?>
										</p>
...
include "tag-product/tag-product3.php"
?></p>
									</div>
							...
							<div class="row">
								...
								<section class="description">
									<p class="description-introduce">
										<?php
include "introduce-trademaker-product/introduce-trademaker-product3.php"
?>
									</p>
									<img src="../img/<?php
include "../php/image-product/image-product11.php"
...
?>" alt="" />
									...
									<div class="introduce">
										...
										<p class="introduce-content">
											<?php
include "commitment-product/commitment-product3.php"
?>
										</p>
									...
									<div class="introduce">
										...
										<p class="introduce-content">
											<?php
include "howtobuy-product/howtobuy-product3.php"
?>
										</p>
									</div>
									...
									<div class="introduce">
										...
										<p class="introduce-content">
											<?php
include "contact-info/contact-info3.php"
?>
										</p>
									</div>
								</section>
								...
								<section class="add-information" style="display: none">
									<div class="size">
										...
										<p class="text"><?php
include "size-product/size-product3.php"
?></p>
									</div>
									...
									<div class="color">
										<p class="name">Màu:</p>
										<p class="text"><?php
include "color-product/color-product3.php"
?></p>
									</div>
									...
									<div class="weight">
										...
										<p class="text"><?php
include "weight-product/weight-product3.php"
?></p>
									</div>
