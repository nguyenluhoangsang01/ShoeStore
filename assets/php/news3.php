			...
			<div class="row">
				<p class="status">
					POSTED ON <span class="time">
						...
						<?php
include "./news-time/news-time3.php"
?>
					</span> BY
					<span class="author">
						<?php
include "../php/news-author/news-author3.php"
?>
					</span>
				</p>
			</div>
...
?>" alt="" />
									<img src="../img/<?php
include "../php/news-image/news-image4.php"
?>" alt="" />
...
?>
									...
									<a href="news4.php" class="">
										<div class="right">
											<?php
include "./news-title/news-title4.php"
?>
