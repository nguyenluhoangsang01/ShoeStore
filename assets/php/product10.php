...
?>
	...
	<div class="cart-shopping">
		<form action="order-pay10.php" method="POST">
			<?php
...
?></a> /
				<a href="product10.php">
					<?php
include "product-title/product-title10.php"
?>
				</a>
			</p>

			<a href="../../admin/edit-product10.php">
			<i class="fas fa-edit"
...
?>" alt="" class="my-slides fade" />
									<img src="../img/<?php
include "../php/image-product/image-product12.php"
?>" alt="" class="my-slides fade" />
									<img src="../img/<?php
include "../php/image-product/image-product14.php"
?>" alt="" class="my-slides fade" />
									<img src="../img/<?php
include "../php/image-product/image-product13.php"
?>" alt="" class="my-slides fade" />
								</div>

								<div class="col l-7">
									<div class="content-product__name" style="line-height: 1.3">
										<?php
include "../php/product-title/product-title10.php"
?>
									</div>
									<div class="content-product__cost">
										<s class="mr2r"><?php include "product-cost/product-cost10.php"?>
										</s>
										<p><?php include "product-sale/product-sale10.php"?>
										</p>
									</div>
									<div class="content-product__list">
										<?php
include "introduce-product/introduce-product10.php"
?>
									</div>
									...
									<div class="select-product select-color">
										...
										<select name="color" id="color">
											...
											<option value="nhung nâu">Nhung nâu</option>
											<option value="nấm">Nấm</option>
											<option value="màu xám nhạt">Xám nhạt</option>
											<option value="màu xám nhạt">Xám đen</option>
										</select>
									</div>
									...
									<a href="order-pay10.php" class="btn buy-product"
										id="buy-product">
										Mua ngay
									</a>
...
include "code-product/code-product10.php"
?>
										</p>
...
include "tag-product/tag-product10.php"
?></p>
									</div>
							...
							<div class="row">
								...
								<section class="description">
									<p class="description-introduce">
										<?php
include "introduce-trademaker-product/introduce-trademaker-product10.php"
?>
									</p>
...
?>" alt="" />
									<img src="../img/<?php
include "../php/image-product/image-product19.php"
?>" alt="" />
									<img src="../img/<?php
include "../php/image-product/image-product18.php"
?>" alt="" />
									<img src="../img/<?php
include "../php/image-product/image-product14.php"
?>" alt="" />
...
?>" alt="" />
									<img src="../img/<?php
include "../php/image-product/image-product16.php"
?>" alt="" />
									<img src="../img/<?php
include "../php/image-product/image-product17.php"
?>" alt="" />
									...
									<div class="introduce">
										...
										<p class="introduce-content">
											<?php
include "commitment-product/commitment-product10.php"
?>
										</p>
									</div>
									...
									<div class="introduce">
										...
										<p class="introduce-content">
											<?php
include "howtobuy-product/howtobuy-product10.php"
?>
										</p>
									</div>
									...
									<div class="introduce">
										...
										<p class="introduce-content">
											<?php
include "contact-info/contact-info10.php"
?>
										</p>
									</div>
								</section>
								...
								<section class="add-information" style="display: none">
									<div class="size">
										...
										<p class="text"><?php
include "size-product/size-product10.php"
?></p>
									</div>
									...
									<div class="color">
										<p class="name">Màu:</p>
										<p class="text"><?php
include "color-product/color-product10.php"
?></p>
									</div>
									...
									<div class="weight">
										...
										<p class="text"><?php
include "weight-product/weight-product10.php"
?></p>
									</div>
...
?>
										...
										<div class="product my-slides fade col">
											<?php
include "component/product8.php"
?>
										</div>
