...
?>
	...
	<div class="cart-shopping">
		<form action="order-pay13.php" method="POST">
			<?php
...
?></a> /
				<a href="product13.php">
					<?php
include "product-title/product-title13.php"
?>
				</a>
			</p>

			<a href="../../admin/edit-product13.php">
			<i class="fas fa-edit"
...
?>" alt="" class="my-slides fade" />
								...
								<div class="col l-7">
									<div class="content-product__name" style="line-height: 1.3">
										<?php
include "../php/product-title/product-title13.php"
?>
									</div>
									<div class="content-product__cost">
										<s class="mr2r"><?php include "product-cost/product-cost13.php"?>
										</s>
										<p><?php include "product-sale/product-sale13.php"?>
										</p>
									</div>
									<div class="content-product__list">
										<?php
include "introduce-product/introduce-product13.php"
?>
									</div>
									...
									<a href="order-pay13.php" class="btn buy-product"
										id="buy-product">
										Mua ngay
									</a>
...
include "code-product/code-product13.php"
?></p>
...
include "tag-product/tag-product13.php"
?></p>
									</div>
							...
							<div class="row">
								...
								<section class="description">
									<p class="description-introduce">
										<?php
include "introduce-trademaker-product/introduce-trademaker-product13.php"
?>
									</p>
...
?>" alt="" />
									...
									<div class="introduce">
										...
										<p class="introduce-content">
											<?php
include "commitment-product/commitment-product13.php"
?>
										</p>
									</div>
									...
									<div class="introduce">
										...
										<p class="introduce-content">
											<?php
include "howtobuy-product/howtobuy-product13.php"
?>
										</p>
									</div>
									...
									<div class="introduce">
										...
										<p class="introduce-content">
											<?php
include "contact-info/contact-info13.php"
?>
										</p>
									</div>
								</section>
								...
								<section class="add-information" style="display: none">
									<div class="size">
										...
										<p class="text"><?php
include "size-product/size-product13.php"
?></p>
									</div>
									...
									<div class="color">
										<p class="name">Màu:</p>
										<p class="text"><?php
include "color-product/color-product13.php"
?></p>
									</div>
									...
									<div class="weight">
										...
										<p class="text"><?php
include "weight-product/weight-product13.php"
?></p>
									</div>
