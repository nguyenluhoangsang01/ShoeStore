...
?>
	...
	<div class="cart-shopping">
		<form action="order-pay4.php" method="POST">
			<?php
...
?></a> /
				<a href="product4.php">
					<?php
include "product-title/product-title4.php"
?>
				</a>
			</p>

			<a href="../../admin/edit-product4.php">
			<i class="fas fa-edit"
...
?>" alt="" class="my-slides fade" />
									<img src="../img/NIKE-FREE-TRAIN-VERSATILITY_1-600x600.jpg"
										alt="" class="my-slides fade" />
									<img src="../img/NIKE-FREE-TRAIN-VERSATILITY_2-600x600.jpg"
										alt="" class="my-slides fade" />
								</div>
								...
								<div class="col l-7">
									<div class="content-product__name" style="line-height: 1.3">
										<?php
include "../php/product-title/product-title4.php"
?>
									</div>
									<div class="content-product__cost">
										<s class="mr2r"><?php include "product-cost/product-cost4.php"?>
										</s>
										<p><?php include "product-sale/product-sale4.php"?>
										</p>
									</div>
									<div class="content-product__list">
										<?php
include "introduce-product/introduce-product4.php"
?>
									</div>
									...
									<div class="select-product select-color">
										...
										<select name="color" id="color">
											...
											<option value="xanh nước">Xanh nước</option>
										</select>
									</div>
									...
									<a href="order-pay4.php" class="btn buy-product"
										id="buy-product">
										Mua ngay
									</a>
...
include "code-product/code-product4.php"
?>
										</p>
...
include "tag-product/tag-product4.php"
?></p>
									</div>
							...
							<div class="row">
								...
								<section class="description">
									<p class="description-introduce">
										<?php
include "introduce-trademaker-product/introduce-trademaker-product4.php"
?>
									</p>
									<img src="../img/<?php
...
?>" alt="" />
									...
									<div class="introduce">
										...
										<p class="introduce-content">
											<?php
include "commitment-product/commitment-product4.php"
?>
										</p>
									</div>
									...
									<div class="introduce">
										...
										<p class="introduce-content">
											<?php
include "howtobuy-product/howtobuy-product4.php"
?>
										</p>
									</div>
									...
									<div class="introduce">
										...
										<p class="introduce-content">
											<?php
include "contact-info/contact-info4.php"
?>
										</p>
									</div>
								</section>
								...
								<section class="add-information" style="display: none">
									<div class="size">
										...
										<p class="text"><?php
include "size-product/size-product4.php"
?></p>
									</div>
									...
									<div class="color">
										<p class="name">Màu:</p>
										<p class="text"><?php
include "color-product/color-product4.php"
?></p>
									</div>
									...
									<div class="weight">
										...
										<p class="text"><?php
include "weight-product/weight-product4.php"
?></p>
									</div>
