...
?>
	...
	<div class="cart-shopping">
		<form action="order-pay20.php" method="POST">
			<?php
	...
	<div class="main-container">
		<section class="title-page row">
			<p>
				...
				<a href="women's-shoes.php"><?php
include "category-product/category-product2.php"
?></a> /
				<a href="product20.php">
					<?php
include "product-title/product-title20.php"
?>
				</a>
			</p>

			<a href="../../admin/edit-product20.php">
				<i class="fas fa-edit"
						...
						<div class="grid wide">
							<div class="row">
								<div class="col l-5 slide-show-container cursor-grab"
									style="height: 100%">
									<img src="../img/<?php
include "../php/image-product/image-product20.php"
...
?>" alt="" class="my-slides fade" />
									<img src="../img/<?php
include "../php/image-product/image-product15.php"
?>" alt="" class="my-slides fade" />
									<img src="../img/<?php
...
?>" alt="" class="my-slides fade" />
								...
								<div class="col l-7">
									<div class="content-product__name" style="line-height: 1.3">
										<?php
include "../php/product-title/product-title20.php"
?>
									</div>
									<div class="content-product__cost">
										<s class="mr2r"><?php include "product-cost/product-cost20.php"?>
										</s>
										<p><?php include "product-sale/product-sale20.php"?>
										</p>
									</div>
									<div class="content-product__list">
										<?php
include "introduce-product/introduce-product20.php"
?>
									</div>
									...
									<a href="order-pay20.php" class="btn buy-product"
										id="buy-product">
										Mua ngay
									</a>
...
include "code-product/code-product20.php"
?>
										</p>
...
include "tag-product/tag-product20.php"
?></p>
									</div>
							...
							<div class="row">
								...
								<section class="description">
									<p class="description-introduce">
										<?php
include "introduce-trademaker-product/introduce-trademaker-product20.php"
?>
									</p>
...
?>" alt="" />
									...
									<div class="introduce">
										...
										<p class="introduce-content">
											<?php
include "commitment-product/commitment-product20.php"
?>
										</p>
									</div>
									...
									<div class="introduce">
										...
										<p class="introduce-content">
											<?php
include "howtobuy-product/howtobuy-product20.php"
?>
										</p>
									</div>
									...
									<div class="introduce">
										...
										<p class="introduce-content">
											<?php
include "contact-info/contact-info20.php"
?>
										</p>
									</div>
								</section>
								...
								<section class="add-information" style="display: none">
									<div class="size">
										...
										<p class="text"><?php
include "size-product/size-product20.php"
?></p>
									</div>
									...
									<div class="color">
										<p class="name">Màu:</p>
										<p class="text"><?php
include "color-product/color-product20.php"
?></p>
									</div>
									...
									<div class="weight">
										...
										<p class="text"><?php
include "weight-product/weight-product20.php"
?></p>
									</div>
