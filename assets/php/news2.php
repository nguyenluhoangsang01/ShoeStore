			...
			<div class="row">
				<p class="status">
					POSTED ON <span class="time">
						<?php
include "./news-time/news-time2.php"
?>
					</span> BY
					<span class="author">
						<?php
include "../php/news-author/news-author2.php"
?>
					</span>
				</p>
			</div>
...
?>" alt="" />
									<img src="../img/<?php
include "../php/news-image/news-image3.php"
?>" alt="" />
									<center>
										<?php
...
?>
								...
								<div class="change-page">
									<a href="news1.php" class="">
										<div class="left">
											<i class="fas fa-arrow-left"></i>
											<?php
include "./news-title/news-title1.php"
?>
										</div>
									</a>

									<a href="news3.php" class="">
										<div class="right">
											<?php
include "./news-title/news-title3.php"
?>
