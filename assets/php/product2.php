...
?>
	...
	<div class="cart-shopping">
		<form action="order-pay2.php" method="POST">
			<?php
...
?>
									...
									<div class="content-product__cost">
										<s class="mr2r"><?php include "product-cost/product-cost2.php"?>
										</s>
										<p><?php include "product-sale/product-sale2.php"?>
										</p>
									</div>
									<div class="content-product__list">
										<?php
include "introduce-product/introduce-product2.php"
?>
									</div>
									...
									<a href="order-pay2.php" class="btn buy-product"
										id="buy-product">
										Mua ngay
									</a>
...
include "code-product/code-product2.php"
?>
										</p>
...
include "tag-product/tag-product2.php"
?></p>
									</div>
							...
							<div class="row">
								...
								<section class="description">
									<p class="description-introduce">
										<?php
include "introduce-trademaker-product/introduce-trademaker-product2.php"
?>
									</p>
									<img src="../img/<?php
...
?>" alt="" />
									...
									<div class="introduce">
										...
										<p class="introduce-content">
											<?php
include "commitment-product/commitment-product2.php"
?>
										</p>
									...
									<div class="introduce">
										...
										<p class="introduce-content">
											<?php
include "howtobuy-product/howtobuy-product2.php"
?>
										</p>
									</div>
									...
									<div class="introduce">
										...
										<p class="introduce-content">
											<?php
include "contact-info/contact-info2.php"
?>
										</p>
									</div>
								</section>
								...
								<section class="add-information" style="display: none">
									<div class="size">
										...
										<p class="text"><?php
include "size-product/size-product2.php"
?></p>
									</div>
									...
									<div class="color">
										<p class="name">Màu:</p>
										<p class="text"><?php
include "color-product/color-product2.php"
?></p>
									</div>
									...
									<div class="weight">
										...
										<p class="text"><?php
include "weight-product/weight-product2.php"
?></p>
									</div>
